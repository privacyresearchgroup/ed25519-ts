...
let edMod = require('../../lib')
let nbi = new edMod.NativeBigInt()
let sha512 = require('js-sha512')
let ed = edMod.makeED(nbi, sha512.sha512)
...
run(async () => {
  ...
  const hash = new Uint8Array([
    ...
    0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad,
    0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde, 0xad, 0xbe, 0xef, 0xde,
