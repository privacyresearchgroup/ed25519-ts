...
describe('ed25519', () => {
    ...
    it('invert works', () => {
        const x = JSBI.BigInt('0x90af56259a4b6bfbc4337980d5d75fbe3c074630368ff3804d33028e5dbfa77')
        const inv = ed.math.invert(x)
        const prod = ed.math.mod(JSBI.multiply(x, inv))
        expect(Number(prod)).toEqual(1)
    })
    it('should not accept >32byte private keys', async () => {
        console.log("don't accept >32byte private key")
        const invalidPriv = JSBI.BigInt(
        ...
        await fc.assert(
            fc.asyncProperty(
                ...
                async (bytes, wrongBytes, privateKey) => {
                    ...
                    const publicKey = await ed.getPublicKey(JSBI.BigInt('0x' + privateKey.toString(16)))
    ...
    describe('BASE_POINT.multiply()', () => {
        ...
        it('should create right publicKey without SHA-512 hashing TEST 1', () => {
            const publicKey = ed.Point.BASE.multiply(
                JSBI.BigInt('0x90af56259a4b6bfbc4337980d5d75fbe3c074630368ff3804d33028e5dbfa77')
            )
        ...
        it('should create right publicKey without SHA-512 hashing TEST 2', () => {
            const publicKey = ed.Point.BASE.multiply(
                JSBI.BigInt('0x364e8711a60780382a5d57b061c126f039940f28a9e91fe039d4d3094d8b88')
            )
        ...
        it('should create right publicKey without SHA-512 hashing TEST 3', () => {
            const publicKey = ed.Point.BASE.multiply(
                JSBI.BigInt('0xb9bf90ff3abec042752cac3a07a62f0c16cfb9d32a3fc2305d676ec2d86e941')
            )
        ...
        it('should create right publicKey without SHA-512 hashing TEST 4', () => {
            const publicKey = ed.Point.BASE.multiply(
                JSBI.BigInt('0x69d896f02d79524c9878e080308180e2859d07f9f54454e0800e8db0847a46e')
            )
        ...
        it('should throw Point#multiply on TEST 5', () => {
            for (const num of [JSBI.BigInt(0), 0, JSBI.BigInt(-1), -1, 1.1]) {
